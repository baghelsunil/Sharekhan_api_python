...
#print(login)
print("-------------------")
request_token="aluG0-7JIdS2Nnx83CaUWWBpjKvB2e1drU8V2X1yMg34r5Tw9G7XZoPq_lmOwzLZ1X9UqHmJOg=="
...
file_path_tele = "script.txt"
with open(file_path_tele, 'w') as file_name:
 print("Script Master : {}".format(order) , file=file_name)
